...
* Main JS
*/
!function(e){"use strict";e(window).on("load",function(){e(".grid").isotope({itemSelector:".grid-item",percentPosition:!0,masonry:{columnWidth:2}})}),e(".slimmenu").slimmenu({resizeWidth:"991",animSpeed:"medium",indentChildren:!0}),(new WOW).init();var t=new Custombox.modal({content:{effect:"push",target:"#search-form"}});e("#search-btn").on("click",function(){t.open()}),e(".modal-header .close").on("click",function(){Custombox.modal.close()}),e("#search-field").ghostHunter({results:"#search-resuls",onKeyUp:!0,info_template:"<p>Number of posts found: {{amount}}</p>",result_template:"<div class='result-item mb-4'><a id='gh-{{ref}}' class='gh-search-item' href='{{link}}'><h4>{{title}}</h4><h5>{{pubDate}}</h5></a></div>"}),e("pre code").each(function(e,t){hljs.highlightBlock(t)}),e(".main-content-area  pb-100 clearfix,.post-content-area,.page-template").fitVids()}(jQuery);
